    ...
    <main className="font-sans text-gray-800 bg-white">
      ...
      <section className="bg-gradient-to-b from-[#f8fbff] to-white py-24 px-6 md:px-16">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-lg mb-12 max-w-3xl mx-auto">
            Experience the future of loan management — automated, intelligent, and transparent.
            Our AI-powered CRM handles everything from lead to disbursement seamlessly.
          </p>
      ...
      <section className="bg-white py-20 px-6 md:px-16">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl md:text-6xl font-bold text-blue-600 mb-4">Our Values</h2>
<p className="text-gray-600 text-lg mb-6">
  Our vision is to create a future where managing customer relationships feels effortless and intelligent.  
  With automation and AI at the core, <span className="font-semibold text-blue-600">Xpertland.Ai</span> enables organizations to focus on what truly matters — building trust, driving engagement, and achieving sustainable growth.
</p>

<p className="text-gray-600 text-lg mb-6">
  We’re not just building software; we’re crafting a digital partner that understands your business needs.  
  From startups to large enterprises, our tools are designed to scale with your journey, helping teams collaborate seamlessly, make data-driven decisions, and deliver exceptional customer experiences.
</p>

<p className="text-gray-600 text-lg">
  At <span className="font-semibold text-blue-600">Xpertland.Ai</span>, we believe that growth happens when technology meets human intent.  
  Our commitment to innovation, reliability, and continuous improvement drives us to simplify complex processes — so you can focus on leading your business to new heights.
</p>
      ...
      <section className="bg-white py-20 px-6 md:px-16">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-bold text-blue-600 mb-14">What Our Clients Say</h2>
          <div className="flex flex-shrink  gap-8">
            <TestimonialCard
              image="https://i.pinimg.com/1200x/3a/02/39/3a023930d3f5f0460ce6aadc4da9c944.jpg"
              name="Sara"
              handle="@saratendularkar"
              quote="Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda porro velit nisi dicta labore eligendi."
            />
            <TestimonialCard
              image="https://i.pinimg.com/736x/eb/76/a4/eb76a46ab920d056b02d203ca95e9a22.jpg"
              name="Guy Hawkins"
              handle="@guythawkins"
              quote="Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis fugiat quos sunt aspernatur, culpa eligendi?"
            />
              ...
              name="Guy Hawkins"
              handle="@guythawkins"
              quote="Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio nisi sit amet consectetur inventore quisquam."
            />
          </div>
