...
const Features = () => {
    ...
    return (
        <section className="relative overflow-hidden py-16 md:py-24 bg-gradient-to-br from-[#f8fbff] via-[#eef3ff] to-[#e0e7ff]">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 text-center py-14 rounded-3xl overflow-hidden">
                {/* Background image */}
                <div
                ...
                <div className="relative z-10">
                    <motion.div
                        ...
                        className="inline-flex items-center justify-center gap-2 bg-white/10 px-6 py-2 rounded-full text-sm font-medium mb-6 border border-white/20 text-white"
                    >
                        <MdOutlineElectricBolt className="text-yellow-300 text-lg" />
                    ...
                    <motion.button
                        ...
                        className="relative z-20 px-8 py-3 bg-white text-blue-700 font-semibold rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:bg-blue-50 active:scale-95 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 cursor-pointer"
                    >
                        Explore Features
                    </motion.button>
            ...
            <motion.div
                ...
                whileInView={{ width: "60%" }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className="h-[2px] mx-auto mt-12 mb-10 bg-gradient-to-r from-blue-400 via-indigo-500 to-transparent rounded-full"
            />
            <div className="max-w-6xl mx-auto px-6 text-center">
                ...
                >
                    ...
                    <p className="text-gray-600 text-base md:text-lg mb-12 md:mb-16 max-w-3xl mx-auto leading-relaxed">
                ...
                {/* Features Grid */}
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 text-left">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            className="p-6 sm:p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 will-change-transform transform-gpu"
                        >
                            <img
                                src={feature.img}
                                alt={feature.title}
                                className="w-full h-48 sm:h-44 object-cover rounded-2xl mb-6"
                            />
                ...
                <motion.div
                    ...
                    className="h-[1px] bg-gradient-to-r from-blue-400 via-indigo-500 to-transparent mt-16 mb-10 rounded-full"
                />
                ...
                >
                    ...
                    <p className="text-gray-600 text-base md:text-lg mb-12 max-w-3xl mx-auto leading-relaxed">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
                        {advancedSecurity.map((item, i) => (
                            <motion.div
                                ...
                                className="p-6 sm:p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 will-change-transform transform-gpu"
                            >
                                <div className="w-10 h-10 text-blue mb-4">{item.icon}</div>
                ...
                >
                    ...
                    <p className="mt-12 text-gray-800 font-medium text-lg">
