            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                ...
                <div className="space-y-12 text-left">
                    ...
                    >
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            We use your data to operate the CRM, process workflows, 
                            provide analytics, enhance AI automation, and improve platform performance.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            ...
                            when necessary to operate platform features.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            You can request data access, deletion, corrections, or export 
