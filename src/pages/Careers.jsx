        ...
        <section className="relative overflow-hidden py-16 md:py-24 bg-gradient-to-br from-[#f8fbff] via-[#eef3ff] to-[#e0e7ff]">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6">
                ...
                <motion.p
                    ...
                    className="text-gray-600 text-center max-w-2xl mx-auto mt-4 leading-relaxed"
                >
                ...
                <motion.div
                    ...
                    className="h-[2px] mx-auto mt-12 mb-16 bg-gradient-to-r from-blue-400 via-indigo-500 to-transparent rounded-full"
                />
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
                    {values.map((v, i) => (
                        ...
                        >
                            <div className="mx-auto mb-4">{v.icon}</div>
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.8 }}
                    className="h-[2px] mx-auto mb-16 bg-gradient-to-r from-blue-400 via-indigo-500 to-transparent rounded-full"
                />
                ...
                <div className="space-y-8 mb-20">
                    {jobs.map((job, i) => (
                        ...
                        >
                            ...
                            <button
                                className="mt-4 px-6 py-2 bg-blue-600 text-white rounded-full text-sm font-medium hover:bg-blue-700 transition"
                            >
                                Apply Now
                            </button>
                        </motion.div>
